            ...
            <div class="p-6 sm:p-8">
              <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
                <div class="flex-1 min-w-0">
                  <h3 class="text-2xl sm:text-3xl font-bold text-slate-50 mb-2 truncate">{{ userStore.user?.name || 'Joueur' }}</h3>
                  <p class="text-sm sm:text-base text-slate-400 truncate">{{ userStore.user?.email }}</p>
                </div>
                <!-- Solde de babayuni - visible sur mobile aussi -->
                <div class="w-full sm:w-auto flex items-center justify-between sm:justify-end gap-3 px-4 py-3 sm:px-0 sm:py-0 rounded-xl sm:rounded-none bg-gradient-to-br from-yellow-500/20 to-orange-500/20 sm:bg-transparent border border-yellow-500/30 sm:border-0">
                  <div class="flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:gap-2">
                      <p class="text-xs sm:text-sm text-slate-400 sm:mb-0 mb-0.5">Babayuni</p>
                      <span class="text-2xl sm:text-3xl font-bold text-yellow-400">{{ userStore.coins }}</span>
                    </div>
                  </div>
                </div>
              </div>
