  ...
  <section class="w-full h-full px-4 sm:px-6 lg:px-12 py-8 overflow-y-auto">
    <div class="max-w-4xl mx-auto">
      ...
      <div v-else class="space-y-6">
        ...
        <div v-if="notificationsStore.unreadInvitations.filter(i => i.invitation.gameType === 'ConnectFour').length > 0 && !currentGame" class="mb-6 p-4 rounded-xl bg-gradient-to-r from-green-900/30 to-blue-900/30 border border-green-500/30">
          <div class="flex items-center gap-3">
            <div class="text-2xl">📬</div>
            <div class="flex-1">
              <p class="text-sm font-medium text-green-300">Vous avez {{ notificationsStore.unreadInvitations.filter(i => i.invitation.gameType === 'ConnectFour').length }} invitation(s) en attente</p>
